...
public class MainActivity extends Activity implements View.OnClickListener, ILayoutListener {
    ...
    private void initializeLayout() {
        ...
        if (mWorkText == null) {
            ...
            String main = SharedPreference.getSharedPreference(getApplicationContext(), getString(R.string.pref_key_work));
            if (main != null) {
                mWorkText.setText(main);
            }
            String bgColor = SharedPreference.getSharedPreference(getApplicationContext(), getString(R.string.pref_key_color_bg));
            if (ResourceUtil.COLOR_LIST != null) {
            	if (ResourceUtil.COLOR_LIST.get(bgColor) != null) {
            		mWorkText.setBackgroundColor(ResourceUtil.COLOR_LIST.get(bgColor));
            	}
            }
        }
    ...
    public void onClick(View v) {
        if (mStartBtn == null || mStopBtn == null || mEditWorkBtn == null || mBgColorBtn == null || mEditWorkView == null
                || mBgColorView == null) {
            return;
        }
    ...
    private void setViewPreference() {
    	if (mWorkText == null) return;
    	String text = SharedPreference.getSharedPreference(getApplicationContext(), getString(R.string.pref_key_work));
    	String bgColor = SharedPreference.getSharedPreference(getApplicationContext(), getString(R.string.pref_key_color_bg));
    	if (text == null) {
    		text = "EditWork";
    	}
    ...
    public void onBackPressed() {
        if (mCurrentView == null || mMainView == null)
            return;
        if (((View)mCurrentView).getVisibility() == View.VISIBLE) {
            if (mCurrentView instanceof EditWorkFrameLayout || mCurrentView instanceof BgColorFrameLayout) {
                end();
                return;
            } 
        } else {
